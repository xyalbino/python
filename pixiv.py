...
class Pixiv():
    ...
    def __init__(self):
        ...
        self.keyword=input("搜索:")
        self.keyword=urllib.parse.urlencode({"word":self.keyword})
        self.target_url =''.join(['https://www.pixiv.net/search.php?s_mode=s_tag&',self.keyword])
        ...
        self.pixiv_id = '1989095112@qq.com'
        self.password = 'wangyuqing960111'
        self.post_key = []
        self.return_to = 'http://www.pixiv.net/'
        self.load_path = 'D:\Python34\pixiv_pic5'
        self.ip_list = []
    ...
    def get_img(self, html, page_num):
        li_soup = BeautifulSoup(html, 'html.parser')  # 传入第page_num页的html
        ...
        for li in li_list:
            ...
            img_soup = BeautifulSoup(jump_to_html, 'html.parser')
    ...
    def work(self):
        self.login()
        for page_num in range(1, 11):  # 太多页了,只跑50页
